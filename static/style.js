...
$('#bDescarga').click(function(){
	var ruta = "./static/manual.pdf";
	window.open(ruta, 'Manual');
});


//  Romulo
//  Av. Rómulo Betancourt No. 2154, Renacimiento, Sto. Dgo. Rep. Dom.
...
$(function() {
	...
	$('select#select').on('change',function(){
		...
		var v_meg = "Megacentro, Pasillo La Fauna, 1er nivel, local 46A, Sto. Dgo. Rep. Dom."
		var v_rom = "Av. Rómulo Betancourt No. 2154, Renaciminto, Sto. Dgo. Rep. Dom."
